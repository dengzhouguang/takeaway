...
public class SPUtils {
    ...
    public  static Object getObjectFromShare(String key) {
        SharedPreferences sharePre = getSharedPreference(CONFIG);
        try {
    ...
    public static boolean putObjectToShare(String key, Object object)
                                        {
        SharedPreferences share = getSharedPreference(CONFIG);
        if (object == null) {
