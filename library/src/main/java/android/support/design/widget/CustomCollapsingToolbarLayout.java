 ...
 * See {@link android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams#COLLAPSE_MODE_PARALLAX} and
 * {@link android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams#setParallaxMultiplier(float)}.
 *
 ...
 * moving. See {@link android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams#COLLAPSE_MODE_PIN}.
 *
...
public class CustomCollapsingToolbarLayout extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        if (parent instanceof AppBarLayout) {
            ...
            if (mOnOffsetChangedListener == null) {
                mOnOffsetChangedListener = new android.support.design.widget.CustomCollapsingToolbarLayout.OffsetUpdateListener();
            }
    ...
    private void updateDummyView() {
        ...
        if (mCollapsingTitleEnabled && mToolbar != null) {
            ...
            if (mDummyView.getParent() == null) {
                mToolbar.addView(mDummyView, android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams.MATCH_PARENT, android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams.MATCH_PARENT);
            }
        }
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mCollapsingTitleEnabled && mDummyView != null) {
            ...
            if (mDrawCollapsingTitle) {
             ...
             /*   Log.e("collapsingRectleft",mTmpRect.left + (isRtl? mToolbar.getTitleMarginEnd(): mToolbar.getTitleMarginStart())+"");
                Log.e("collapsingRecttop",mTmpRect.top + maxOffset + mToolbar.getTitleMarginTop()+"");
                Log.e("collapsingRectright",mTmpRect.right + (isRtl? mToolbar.getTitleMarginStart() : mToolbar.getTitleMarginEnd())+"");
                Log.e("collapsingRectBottom",mTmpRect.bottom + maxOffset - mToolbar.getTitleMarginBottom()+"");*/
    ...
    void setScrimAlpha(int alpha) {
        if (alpha != mScrimAlpha) {
            ...
            mScrimAlpha = alpha;
            ViewCompat.postInvalidateOnAnimation(android.support.design.widget.CustomCollapsingToolbarLayout.this);
        }
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams;
    }

    @Override
    protected android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams generateDefaultLayoutParams() {
        return new android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams(android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams.MATCH_PARENT, android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams.MATCH_PARENT);
    }

    @Override
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams(getContext(), attrs);
    }

    @Override
    protected FrameLayout.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams(p);
    }
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
         ...
         * {@link android.support.design.widget.CustomCollapsingToolbarLayout}.
         */
         ...
         */
        public void setCollapseMode(@android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams.CollapseMode int collapseMode) {
         ...
         * or {@link #COLLAPSE_MODE_PARALLAX}.
         */
        @android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams.CollapseMode
    ...
    final int getMaxOffsetForPinChild(View child) {
        ...
        final android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams lp = (android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams) child.getLayoutParams();
        return getHeight()
...
//            Log.e("verticalOffset",verticalOffset+"   "+ StatusBarUtils.getStatusBarHeight(App.app)+"  "+mToolbar.getHeight()+"  "+getHeight());
            final int insetTop = mLastInsets != null ? mLastInsets.getSystemWindowInsetTop() : 0;
            ...
            for (int i = 0, z = getChildCount(); i < z; i++) {
                ...
                switch (lp.mCollapseMode) {
                    case android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams.COLLAPSE_MODE_PIN:
                        offsetHelper.setTopAndBottomOffset(MathUtils.clamp(
                                -verticalOffset, 0, getMaxOffsetForPinChild(child)));
                        break;
                    case android.support.design.widget.CustomCollapsingToolbarLayout.LayoutParams.COLLAPSE_MODE_PARALLAX:
...
//            updateScrimVisibility();
            ...
            final int expandRange = getHeight() - ViewCompat.getMinimumHeight(
                    android.support.design.widget.CustomCollapsingToolbarLayout.this) - insetTop;
